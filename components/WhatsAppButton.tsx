  ...
  return (
    <div className="fixed bottom-8 right-8 z-[100] group">
      ...
      <a
        ...
        className="flex items-center justify-center w-14 h-14 md:w-16 md:h-16 bg-pine-accent text-white rounded-full shadow-2xl shadow-pine-accent/40 hover:scale-110 active:scale-95 transition-all duration-300 relative overflow-hidden group"
